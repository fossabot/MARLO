...
@Mapper
public interface FundingSourceAgreementMapper {
  ...
  FundingSourceAgreementDTO
    fundingSourceAgreementToFundingSourceAgreementDTO(FundingSourceAgreement fundingSourceAgreement);
