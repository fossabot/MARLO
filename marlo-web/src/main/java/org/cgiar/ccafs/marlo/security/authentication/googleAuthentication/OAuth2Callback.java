...
public class OAuth2Callback extends HttpServlet {
  ...
  static String className = "authentication/googleAuthentication.Oauth2callback";

  @Override
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    try {
      String code = request.getParameter("code");
      String urlParameters = "code=" + code + "&client_id=" + Setup.CLIENT_ID + "&client_secret=" + Setup.CLIENT_SECRET
        + "&redirect_uri=" + Setup.REDIRECT_URL + "&grant_type=authorization_code";
      ...
      GooglePojo data = new Gson().fromJson(line1, GooglePojo.class);
      writer.close();
      reader.close();
