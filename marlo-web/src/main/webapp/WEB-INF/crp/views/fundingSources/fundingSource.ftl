      ...
      <div class="form-group-donor">
        ...
        <div class="form-group row">
          <div class="col-md-12 metadataElement-directDonorName">
            ...
            <span class="text-warning metadataSuggested">${(theAgreement.directDonor.name)!}</span> 
          </div>
        </div>
        ...
        <div class="form-group row">
          <div class="col-md-12 metadataElement-originalDonorName">
            ...
            <span class="text-warning metadataSuggested">${(theAgreement.originalDonor.name)!}</span> 
          </div>
        </div>
